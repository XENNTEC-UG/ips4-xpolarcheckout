...
> Polar Checkout gateway for IPS Nexus. `xpolarcheckout` delivers hosted payments, webhook reconciliation, and integrity tooling while the migration from Stripe baseline code is completed.
