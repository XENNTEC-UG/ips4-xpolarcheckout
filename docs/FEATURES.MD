...
### Implemented but not yet listed above
- **ACP member profile block** (`PolarPaymentSummary`): shows transaction count, refund count, and last activity on ACP member profiles.
