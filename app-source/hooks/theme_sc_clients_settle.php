 ...
 return array_merge_recursive( array (
  ...
  array (
	...
	<div class=\'ipsBox ipsBox--child ipsPadding\'>
		...
		<span class=\'cNexusPrice\' style=\'font-size: 1.4em;\'>{{if !empty( $stripeSnapshot[ \'amount_total_display\' ] )}}{$stripeSnapshot[ \'amount_total_display\' ]}{{else}}{$invoice->total}{{endif}}</span>
		<p class=\'ipsType_light ipsType_small ipsType_reset ipsSpacer_top ipsSpacer_half\'>{lang="xpolarcheckout_stripe_charged_label"}</p>
